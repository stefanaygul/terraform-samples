...
output "id" {
  ...
  value       = try(aws_ecs_service.entr_service[0].id, aws_ecs_service.ignore_task_definition[0].id, null)
}

output "name" {
  description = "Name of the service"
  value       = try(aws_ecs_service.entr_service[0].name, aws_ecs_service.ignore_task_definition[0].name, null)
}
...
output "task_definition_arn" {
  ...
  value       = try(aws_ecs_task_definition.entr_task_def[0].arn, null)
}

output "task_definition_revision" {
  description = "Revision of the task in a particular family"
  value       = try(aws_ecs_task_definition.entr_task_def[0].revision, null)
}

output "task_definition_family" {
  description = "The unique name of the task definition"
  value       = try(aws_ecs_task_definition.entr_task_def[0].family, null)
}
...
output "task_set_id" {
  ...
  value       = try(aws_ecs_task_set.entr_task_set[0].task_set_id, aws_ecs_task_set.ignore_task_definition[0].task_set_id, null)
}

output "task_set_arn" {
  description = "The Amazon Resource Name (ARN) that identifies the task set"
  value       = try(aws_ecs_task_set.entr_task_set[0].arn, aws_ecs_task_set.ignore_task_definition[0].arn, null)
}
...
output "task_set_stability_status" {
  ...
  value       = try(aws_ecs_task_set.entr_task_set[0].stability_status, aws_ecs_task_set.ignore_task_definition[0].stability_status, null)
}

output "task_set_status" {
  description = "The status of the task set"
  value       = try(aws_ecs_task_set.entr_task_set[0].status, aws_ecs_task_set.ignore_task_definition[0].status, null)
}
...
output "autoscaling_policies" {
  ...
  value       = aws_appautoscaling_policy.entr_app_asg_policy
}

output "autoscaling_scheduled_actions" {
  description = "Map of autoscaling scheduled actions and their attributes"
  value       = aws_appautoscaling_scheduled_action.entr_app_asg_schedule
}
...
output "security_group_arn" {
  ...
  value       = try(aws_security_group.entr_ecs_sg[0].arn, null)
}

output "security_group_id" {
  description = "ID of the security group"
  value       = try(aws_security_group.entr_ecs_sg[0].id, null)
}